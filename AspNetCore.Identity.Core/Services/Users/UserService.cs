...
public class UserService : IUserService
{
    ...
    private readonly IdentityDbContext<User> identityDataContext;
    ...
    public UserService(
        IdentityDbContext<User> identityDataContext,
    ...
    {
        var claims = (await userManager.GetClaimsAsync(user)).Where(x => x.Type is Brupper.AspNetCore.Identity.Services.Users.IdentityConstants.ModuleClaimType).ToList();
        if (claims.Any())
        {
