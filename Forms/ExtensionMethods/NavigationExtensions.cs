...
{
    //public static async Task<TResult> Navigate<TViewModel, TResult>(this ViewModelBase viewModel)
    ...
    //public static Task<bool> Navigate<TViewModel>(this ViewModelBase viewModel)
    //    where TViewModel : IMvxViewModelResult<bool> 
    //    => viewModel.Navigate<TViewModel, bool>();

    //public static async Task<TResult> Navigate<TViewModel, TParam, TResult>(this ViewModelBase viewModel, TParam parameter)
