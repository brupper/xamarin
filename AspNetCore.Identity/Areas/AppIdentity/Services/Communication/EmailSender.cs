...
public class EmailSender(IEmailServiceFactory emailServiceFactory) : IEmailSender, IEmailSender<User>
{
    ...
    public Task SendPasswordResetCodeAsync(User user, string email, string resetCode)
        => throw new NotImplementedException("SendPasswordResetCodeAsync is not implemented in Brupper.AspNetCore.Identity.Areas.AppIdentity.Services.Communication.EmailSender<User>");
