...
namespace Administration.Identity.Areas.AppIdentity;
...
public static partial class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        accountGroup.MapGet("/info", async Task<Results<Ok<InfoResponse>, ValidationProblem, UnauthorizedHttpResult>>
