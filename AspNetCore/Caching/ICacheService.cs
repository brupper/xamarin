...
/// <summary> ICacheService encapsulates IMemoryCache functionality. </summary>
public interface ICacheService
{
    ...
    /// <param name="size">Gets or sets the size of the cache entry value. If you set it to 1, the size limit will be the count of entries.</param>
    /// <typeparam name="T"></typeparam>
    Task AddAsync<T>(string cacheKey, Func<Task<T>> factory, DateTimeOffset absoluteExpiration, int size = 1);
