...
public sealed class ConnectionStringParser
{
    ...
    public static ConnectionStringParser Parse(string connectionString, string segmentSeparator = ";", string keywordValueSeparator = "=", bool allowEmptyValues = false)
    {
        Validate(connectionString, segmentSeparator, keywordValueSeparator, allowEmptyValues);
        return new ConnectionStringParser(ParseSegments(connectionString, segmentSeparator, keywordValueSeparator), segmentSeparator, keywordValueSeparator);
    }

    public static ConnectionStringParser Empty(string segmentSeparator = ";", string keywordValueSeparator = "=") =>
        new(new Dictionary<string, string>(), segmentSeparator, keywordValueSeparator);

    private ConnectionStringParser(Dictionary<string, string> pairs, string pairSeparator, string keywordValueSeparator)
    {
        this.pairs = pairs;
