...
public partial class AutoCompleteView
{
    ...
    public static readonly BindableProperty SuggestionBackgroundColorProperty = BindableProperty.Create(nameof(SuggestionBackgroundColor), typeof(Color), typeof(AutoCompleteView), Colors.Transparent);
    ...
    public static readonly BindableProperty FontSizeProperty = BindableProperty.Create(nameof(FontSize), typeof(double), typeof(AutoCompleteView), (new Label() as Microsoft.Maui.Controls.Internals.IFontElement).FontSizeDefaultValueCreator());
    ...
    private void PlaceSuggestionPanel()
    {
        ...
        else
        {
            if (SuggestedItemsContainerTop.Children.Any())
            {
                ...
                SuggestedItemsContainerTop.Children.Remove(suggestionPanel);
                OptionalSuggestionsPanelContainer.Children.Add((View)suggestionPanel);
            }
