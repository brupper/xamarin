...
using XfView = Microsoft.Maui.Controls.View;
...
public static class ViewExtensions
{
    ...
    public static void FixPageOniOS(this Microsoft.Maui.Controls.Page page)
    {
        ...
        if (DeviceInfo.Platform == DevicePlatform.iOS)
        {
            ...
            //if (page is ContentPage cp && cp.Content is ScrollView scrollView)
            //{
    ...
    public static void CloseMenu(this Element view)
    {
        var p = view.Parent;
        /*
    ...
    /// <summary></summary>
    public static async Task<double> GetHeightOfWebViewAsync(this WebView webView)
    {
        try
        {
    ...
    /// <summary></summary>
    public static async Task<double> GetWidthOfWebViewAsync(this WebView webView)
    {
        try
        {
            if (webView?.Source == null)
    ...
    public static async Task<double> NormalizeWidthOfWebViewAsync(this WebView webView)
    {
    ...
    /// <summary> UWP! </summary>
    public static async Task<double> CalculateHeightOfWebViewAsync(this WebView webView)
    {
        try
        {
            if (webView?.Source == null)
    ...
    /// <summary> UWP! </summary>
    public static async Task<double> CalculateWidthOfWebViewAsync(this WebView webView)
    {
        try
        {
            if (webView?.Source == null)
