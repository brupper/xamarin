...
public class EntryEffect : RoutingEffect
{
    ...
    public static readonly BindableProperty BackgroundColorProperty
            = BindableProperty.CreateAttached("BackgroundColor", typeof(Color), typeof(EntryEffect), Colors.White, propertyChanged: OnPropertyChanged);
    ...
    public static readonly BindableProperty BorderColorProperty
            = BindableProperty.CreateAttached("BorderColor", typeof(Color), typeof(EntryEffect), Colors.White, propertyChanged: OnPropertyChanged);
