...
namespace Brupper.Maui.Effects;
...
public class PickerEffect : RoutingEffect
{
    ...
    public static readonly BindableProperty BackgroundColorProperty
            = BindableProperty.CreateAttached("BackgroundColor", typeof(Color), typeof(PickerEffect), Colors.White, propertyChanged: OnPropertyChanged);
    ...
    public static readonly BindableProperty BorderColorProperty
            = BindableProperty.CreateAttached("BorderColor", typeof(Color), typeof(PickerEffect), Colors.White, propertyChanged: OnPropertyChanged);
